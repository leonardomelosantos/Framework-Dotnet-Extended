...
namespace FrameworkDotNetExtended.Helpers
{
    public class CriptografiaHelper
    {
        ...
        /// <param name="encrypt"></param>
        /// <returns></returns>
        public static string DecryptSimples(string encrypt)
        {
            /*string cipherText = encrypt; // Encripted text

            string passPhrase = "c133p3"; // can be any string
            string saltValue = "p30pl3"; // can be any string
            string hashAlgorithm = "MD5"; // can be "SHA1"
            int passwordIterations = 2; // can be any number
            string initVector = "@1B2c3D4e5F6g7H8"; // must be 16 bytes
            int keySize = 128; // can be 192 or 128

            string plainText = Criptografia.Decrypt(cipherText,
                                                        passPhrase,
                                                        saltValue,
                                                        hashAlgorithm,
                                                        passwordIterations,
        ...
        /// <param name="decrypt"></param>
        /// <returns></returns>
        public static string EncryptSimples(string decrypt)
        {
            /*string plainText = decrypt; // original plaintext
            ...
            string cipherText = Criptografia.Encrypt(plainText, passPhrase, saltValue,
                hashAlgorithm, passwordIterations, initVector, keySize);
            */
            string cipherText = Encrypt(decrypt);
            return cipherText;
        }
